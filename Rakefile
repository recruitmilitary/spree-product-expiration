...
desc 'Generate documentation for the product_expiration extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductExpirationExtension'
...
desc 'Test the product_expiration extension.'
...
namespace :test do
  desc 'Functional test the product_expiration extension.'
  ...
  desc 'Unit test the product_expiration extension.'
